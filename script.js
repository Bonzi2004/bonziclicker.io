document.addEventListener('DOMContentLoaded', () => {
    ...
    let username = localStorage.getItem('username') || 'BonziClicker';
    ...
    const skins = [
        ...
        { id: 7, name: "Бонзе Игрушко", price: 20000, url: "https://i.ibb.co/tpFYvL4Z/534-20250606153219.png" },
    ...
    promoButton.addEventListener('click', () => {
        ...
        if (["Bueno000", "кортел", "Chomikbox", "virusnewsi"].includes(promo)) {
        ...
        // Определение бонусов для каждого промокода
        if (promo === "Bueno000") {
            bonus = 10000;
        ...
        } else if (promo === "virusnewsi") {
            bonus = 80000;
        } else if (promo === "virusnewsskin") {
            // Многоразовый промокод для скина
            skinUrl = "https://i.ibb.co/V0XKKPMS/524-20250531143713.png";
        }
